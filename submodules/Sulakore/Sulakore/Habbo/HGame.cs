    ...
    public class HGame : ShockwaveFlash
    {
        ...
        protected void RenameIdentifiers()
        {
            ...
            foreach (SymbolClassTag symbolTag in Tags
                ...
                .Cast<SymbolClassTag>())
            {
                var entriesCopy = symbolTag.Entries.ToArray();
                
                symbolTag.Entries.Clear();
                
                foreach (var entry in entriesCopy.ToArray())
                {
                    string fullName = entry.Item2;
                    ...
                    symbolTag.Entries.Add(new Tuple<ushort, string>(entry.Item1, fixedFullName));
                }
            }
            #endregion
        }
