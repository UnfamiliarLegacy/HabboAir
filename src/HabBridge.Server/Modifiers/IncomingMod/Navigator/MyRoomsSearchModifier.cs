...
namespace HabBridge.Server.Modifiers.IncomingMod.Navigator
{
    ...
    }, Incoming.MyRoomsSearch)]
    public class MyRoomsSearchModifier : PacketModifierBase
    {
        private const string Category = "myworld_view";

        private const string CategoryId = "my";

        public MyRoomsSearchModifier(ClientConnection connection, IPacket packetOriginal, Release releaseFrom, Release releaseTarget) : base(connection, packetOriginal, releaseFrom, releaseTarget)
        {
        }
