...
namespace HabBridge.Server.Modifiers.IncomingMod.Navigator
{
    ...
    }, Incoming.MyRoomHistorySearch)]
    public class MyRoomHistorySearchModifier : PacketModifierBase
    {
        private const string Category = "myworld_view";

        private const string CategoryId = "history_freq";

        public MyRoomHistorySearchModifier(ClientConnection connection, IPacket packetOriginal, Release releaseFrom, Release releaseTarget) : base(connection, packetOriginal, releaseFrom, releaseTarget)
        {
        }
