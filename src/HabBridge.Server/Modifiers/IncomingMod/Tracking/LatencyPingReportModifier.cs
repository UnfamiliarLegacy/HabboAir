...
namespace HabBridge.Server.Modifiers.IncomingMod.Tracking
{
    ...
    }, Incoming.LatencyPingReport)]
    public class LatencyPingReportModifier : PacketModifierBase
    {
        public LatencyPingReportModifier(ClientConnection connection, IPacket packetOriginal, Release releaseFrom, Release releaseTarget) : base(connection, packetOriginal, releaseFrom, releaseTarget)
        {
        }
